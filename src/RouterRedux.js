    ...
    switch (action.type) {
        ...
        case CHANGE_LOCATION:
            ...
            state
                .locations
                .map((item, index) => {
                    const itemParams = item.match
                        ? item.match.params
                        : '';
                    const actionParam = locationItem.match
                        ? locationItem.match.params
                        : '';
                    let newItem = {
                        ...item
                    };
            ...
            return {locations: locations, urlStack: urlStack}
        case DELETE_LOCATION:
            ...
            locations = [
                ...state
                    .locations
                    .slice(0, action.locationIndex),
                ...state
                    .locations
                    .slice(action.locationIndex + 1)
            ];
